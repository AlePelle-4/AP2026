...
int main() {
    ...
    if ( leggi_netlist(nomefile,Nome_res,resistenze,generatori,grafo) ) {
        ...
        //otteniamo i vettori C con i cicli fondamentali, con i loro versi di percorrenza
        ...
        for (auto it=resistenze.begin();it!=resistenze.end();++it) {
            ...
            // Nei cicli fondamentali ci sono anche gli archi dei generatori (dobbiamo togliere le righe corrispondenti)
